...
var _Cu$import = Cu.import('resource://gre/modules/Timer.jsm', {}),
    setTimeout = _Cu$import.setTimeout;

var _Cu$import2 = Cu.import('resource://gre/modules/devtools/Console.jsm', {}),
    console = _Cu$import2.console;
...
var _Cu$import3 = Cu.import('resource://getbot/wampy/constants.js', {}),
    WAMP_MSG_SPEC = _Cu$import3.WAMP_MSG_SPEC,
    WAMP_ERROR_MSG = _Cu$import3.WAMP_ERROR_MSG;

var _Cu$import4 = Cu.import('resource://getbot/wampy/utils.js', {}),
    getWebSocket = _Cu$import4.getWebSocket;

var _Cu$import5 = Cu.import('resource://getbot/wampy/serializers/JsonSerializer.js', {}),
    JsonSerializer = _Cu$import5.JsonSerializer;
                        ...
                        if (_this3._cache.sessionId) {
                            ...
                            if (_this3._options.authid && typeof _this3._options.onChallenge === 'function') {
                                ...
                                p.then(function (key) {
                                    ...
                                    if (_this3._options.onError) {
                                        _this3._options.onError({ error: WAMP_ERROR_MSG.CRA_EXCEPTION.description });
                                    }
                                    _this3._ws.close();
                                ...
                                _this3._ws.send(_this3._encode([WAMP_MSG_SPEC.ABORT, { message: WAMP_ERROR_MSG.NO_CRA_CB_OR_ID.description }, 'wamp.error.cannot_authenticate']));
                                if (_this3._options.onError) {
                                    _this3._options.onError({ error: WAMP_ERROR_MSG.NO_CRA_CB_OR_ID.description });
                                }
                                _this3._ws.close();
                                _this3._cache.opStatus = WAMP_ERROR_MSG.NO_CRA_CB_OR_ID;
                            }
                        }
                        break;
                    case WAMP_MSG_SPEC.GOODBYE:
                        ...
                        if (!_this3._cache.sessionId) {
                            ...
                            if (!_this3._cache.isSayingGoodbye) {
                                ...
                                _this3._send([WAMP_MSG_SPEC.GOODBYE, {}, 'wamp.close.goodbye_and_out']);
                            }
                        ...
                        if (!_this3._cache.sessionId) {
                            ...
                            if (_this3._rpcRegs[data[2]]) {
                                ...
                                var invoke_result_handler = function invoke_result_handler(results) {
                                    ...
                                    // ArgumentsKw|dict)]
                                    var msg = [WAMP_MSG_SPEC.YIELD, data[1], {}];
                                    ...
                                    var msg = [WAMP_MSG_SPEC.ERROR, WAMP_MSG_SPEC.INVOCATION, data[1], details || {}, error || 'wamp.error.invocation_exception'];
                                ...
                                _this3._send([WAMP_MSG_SPEC.ERROR, WAMP_MSG_SPEC.INVOCATION, data[1], {}, 'wamp.error.no_such_procedure']);
                                _this3._cache.opStatus = WAMP_ERROR_MSG.NON_EXIST_RPC_INVOCATION;
                            }
                        }
                        break;
